...
class YOLOv8Trainer(BaseTrainer):
    ...
    def __init__(self, *args, model_size: str = 's', **kwargs):
        ...
        logger.info(f"YOLOv8训练器初始化，模型尺寸: {model_size} ({self.model_name})")
